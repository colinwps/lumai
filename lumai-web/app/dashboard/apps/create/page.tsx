    ...
    return (
        <div className="max-w-2xl mx-auto space-y-6">
            <div>
                ...
                <p className="text-muted-foreground">Configure your new AI application.</p>
            </div>
            ...
            <div className="rounded-lg border bg-card text-card-foreground shadow-sm p-6">
                <form className="space-y-4">
                    <div className="space-y-2">
                        ...
                        <input className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50" placeholder="My App" />
                    </div>
                    <div className="space-y-2">
